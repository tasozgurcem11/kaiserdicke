...
EMAIL_HOST_USER = 'info@kaiserdicke.de'
EMAIL_HOST_PASSWORD = 'K34RnxQF'
EMAIL_PORT = 587
EMAIL_USE_TLS = True
...
if os.getenv('GAE_APPLICATION', None):
    ...
    DATABASES = {
        'default': {
            ...
            'HOST': '/cloudsql/kaiserdicke:europe-west3:polls-instance',
            'NAME': 'main',
            'USER': 'cem',
            'PASSWORD': 'Ba2r%sTr0',
        }
    ...
    GS_BUCKET_NAME = 'kaiserdicke.appspot.com'
    # Make sure to get a JSON key under IAM & Admin -> Service Accounts -> Keys
    GS_KEY_FILENAME = "kaiserdicke_key.json"
